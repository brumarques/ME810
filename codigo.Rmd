...
pureErrorAnova(fit)
```
Como podemos ver, os p-valores encontrados são próximos de zero, ou seja, as condiçoes de normalidade, independência e homocedasticiade da variância dos resíduos são satisfeitas.  
